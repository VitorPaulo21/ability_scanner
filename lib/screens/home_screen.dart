                  ...
                  return ListTile(
                    ...
                    trailing: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            produtosProvider.removeProduto(
                                produtosProvider.produtos[index]);
                          },
                    ...
                    onPressed: () async {
                      ...
                      showDialog<Map<String, Object>>(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    if (!isExistentProduct)
                                      const Text(
                                          "Produto não adicionado ao sistema"),
                                    if (isExistentProduct)
                                ...
                                TextButton(
                                  onPressed: () {
                                    ...
                                    if (isvalid && isExistentProduct) {
                                      bool willRemove = produtosProvider
                                              .produtos
                                              .firstWhere((element) =>
                        ...
                        if (data != null) {
                          ...
                          if (data.containsKey("willRemove") ?? false) {
